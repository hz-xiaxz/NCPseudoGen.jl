...
DocMeta.setdocmeta!(NCPseudoGen, :DocTestSetup, :(using NCPseudoGen); recursive = true)

# Add titles of sections and overrides page titles
const titles = Dict(
    # "10-tutorials" => "Tutorials", # example folder title
    "numerov.md" => "Numerov Method",
...
makedocs(;
    modules = [NCPseudoGen],
    authors = "xuanzhe xia <hzxiaxz@gmail.com>",
    repo = "https://github.com/hz-xiaxz/NCPseudoGen.jl/blob/{commit}{path}#{line}",
    sitename = "NCPseudoGen.jl",
    format = Documenter.HTML(; canonical = "https://hz-xiaxz.github.io/NCPseudoGen.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/hz-xiaxz/NCPseudoGen.jl")
